<?php /* SQL Queries */
    ...
    function sql_query_chatroom($userid, $chatroomid) {
        $query = 'SELECT Title, Description, Owner, To_char(creationdate, \'DD-Mon-YYYY, HH24:MI\'), readingperm, postingperm, rating, closed, canpost FROM getChatrooms($1) WHERE RoomID = $2';
